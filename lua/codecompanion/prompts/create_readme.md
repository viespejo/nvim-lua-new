...
1. Review the entire project workspace and codebase, ignoring irrelevant files and directories in .gitignore. Find and read relevant files to understand the project's purpose, features, installation steps, usage, and contribution guidelines.
...
Create the README.md file in the project root. Check if a README.md file already exists; if so, update it with any missing or improved information.
...
- @{file_search}: Search for files in the current working directory
- @{read_file}: Read the contents of a file
- @{create_file}: Create a new file with specified content
- @{insert_edit_into_file}: Insert or edit content in an existing file
- @{neovim__read_multiple_files}: Read multiple files in one go if needed

Note: prioritize reading files using @{neovim__read_multiple_files} if there are many files to review.
