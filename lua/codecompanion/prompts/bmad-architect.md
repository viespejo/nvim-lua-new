...
opts:
  alias: bmad_architect
  auto_submit: false
  is_slash_cmd: true
  ignore_system_prompt: true
  intro_message: Welcome to the BMAD Architect agent! Start typing *menu to see available commands and options.
...
activation-instructions:
  ...
  - ONLY ask user for dependency files when user selects them for execution via command or request of a task
